                ...
                <div class="app-sidebar">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item {{ request()->is('menu/previred') ? 'active' : '' }}" data-bs-toggle="slide" href="{{ route('menu.previred') }}"><i class="side-menu__icon fa fa-industry"></i><span class="side-menu__label">En Previred</span></a>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item {{ request()->is('menu/silvertool') ? 'active' : '' }}" data-bs-toggle="slide" href="{{ route('menu.silvertool') }}"><i class="side-menu__icon fa fa-industry"></i><span class="side-menu__label">En SilverTool</span></a>
                            </li>
                            <li class="sub-category">
                                <h3>Extracción de datos</h3>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item {{ request()->is('menu/download_pdf') ? 'active' : '' }}" data-bs-toggle="slide" href="{{ route('menu.download_pdf') }}"><i class="side-menu__icon fa fa-industry"></i><span class="side-menu__label">Descarga de PDF's</span></a>
                            </li>
            ...
            <div class="container">
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-md-12 col-sm-12 text-center">
                        Copyright © <span id="year"></span> <a href="javascript:void(0)">Fiabilis Consulting Group</a>. All rights reserved.
                    </div>
                </div>
            </div>
        </footer>
